        ...
        <div className="wrapper py-12">
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
            ...
            <nav className="flex flex-wrap gap-x-6 gap-y-2 text-sm">
              <Link to="/about" className="text-stone hover:text-primary transition-colors">
                About
              </Link>
              <Link to="/privacy" className="text-stone hover:text-primary transition-colors">
                Privacy
              </Link>
              <Link to="/terms" className="text-stone hover:text-primary transition-colors">
                Terms
              </Link>
              <a href="https://github.com/dacrab/mise" className="text-stone hover:text-primary transition-colors">
                GitHub
              </a>
            </nav>
          </div>
