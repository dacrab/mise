  ...
  return (
    <div className="max-w-md mx-auto mt-20 p-8 bg-white rounded-3xl shadow-xl shadow-black/5 border border-brand-border animate-fade-in">
          ...
          {form.password && (
            <div className="pt-2 space-y-2 px-1">
              ...
              <div className="flex justify-between items-center text-[10px] font-bold uppercase tracking-widest">
                ...
                <span className={strength > 0 ? color.replace("bg-", "text-") : "text-zinc-400"}>
                  {label}
                </span>
              </div>
            </div>
      ...
      <p className="mt-8 text-center text-sm text-gray-500">
        ...
        <a href="/login" className="text-brand-primary font-bold hover:underline">
          Sign In
        </a>
      </p>
    </div>
